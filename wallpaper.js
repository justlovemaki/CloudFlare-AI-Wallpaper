      ...
      <html>
        <head>
          ...
          <style>
            ...
            #modelToggleButton { background: #2196F3; color: white; padding: 6px 12px; border-radius: 8px; cursor: pointer; transition: all 0.3s; }
            #modelToggleButton:hover { background: #0b7dda; }
        ...
        <body>
          ...
          <div class="button-container">
            ...
            <button id="modelToggleButton">切换到 SF-Kolors</button>
          </div>
          ...
          <script>
            ...
            const showStyle = style => {
              ...
              const url = \`https://文生图服务路径/?model=\${currentModel}&width=1280&height=720&expand=1&prompt=\${encodeURIComponent(style)}++\${randomString}\`;
              image.src = url;
            };
